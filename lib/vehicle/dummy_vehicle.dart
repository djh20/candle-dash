...
class DummyVehicle extends Vehicle {
  DummyVehicle() {
    ...
    registerMetrics([
      ...
      MetricFloat(id: StandardMetric.speed.id, initialValue: 20.83, precision: 2, unit: Unit.kilometersPerHour),
      ...
      MetricInt(id: StandardMetric.chargeStatus.id, initialValue: 1),
      MetricFloat(id: StandardMetric.steeringAngle.id, initialValue: -0.53, precision: 2),
      ...
      MetricInt(id: StandardMetric.parkBrake.id, initialValue: 1),
    ]);
  }
}